...
// GetChatCompletionsOptions contains the optional parameters for the Client.GetChatCompletions
// method.
...
// GetImageOperationStatusOptions contains the optional parameters for the Client.GetImageOperationStatus
// method.
type GetImageOperationStatusOptions struct {
	// placeholder for future optional parameters
}

// StartGenerateImageOptions contains the optional parameters for the Client.StartGenerateImage
// method.
type StartGenerateImageOptions struct {
	// placeholder for future optional parameters
}
