...
func (m *MockAMQPSender) Declare(ctx context.Context, msg amqp.TransactionDeclare, o *amqp.SendOptions) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockAMQPSender) Discharge(ctx context.Context, discharge amqp.TransactionDischarge, opts *amqp.SendOptions) error {
	m.ctrl.T.Helper()
...
// Declare mocks base method.
func (m *MockAMQPSenderCloser) Declare(ctx context.Context, msg amqp.TransactionDeclare, o *amqp.SendOptions) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Declare", ctx, msg, o)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
...
// Discharge mocks base method.
func (m *MockAMQPSenderCloser) Discharge(ctx context.Context, discharge amqp.TransactionDischarge, opts *amqp.SendOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Discharge", ctx, discharge, opts)
	ret0, _ := ret[0].(error)
	return ret0
